(() => {
    ...
    const I18N = {
        en: {
            ...
            "ui.keyPlannerShort": "Key Planner",
            "ui.keysPlannerPlusOfficial": "Keys Planner + Official",
            "ui.mooket": "Mooket",
            "ui.keysPlannerPlusMooket": "Keys Planner + Mooket",
            "ui.pricingApiTypeTip": "API: {source}",
            "ui.pricingApiDetailsAria": "Pricing API details",
            "ui.market": "market",
            "ui.mixed": "mixed",
            ...
            "ui.tipDailyKeySavings": "Key savings/day: {value}",
            ...
            "ui.keysImportPreviewWithPrices": "(API: {source}) Entry {entry} | Chest {chest}",
            "ui.keysImportDeltaSaving": "Saving {value}",
            "ui.keysImportDeltaWasting": "Wasting {value}",
            ...
            "ui.keysDailySavingsAria": "Daily key savings details",
            "ui.keysDailySavingsTitle": "Daily key savings vs {source} API buy price",
            "ui.keysDailySavingsEntryLine": "Entry key: {each} each x {count} = {total}",
            "ui.keysDailySavingsChestLine": "Chest key: {each} each x {count} = {total}",
            "ui.keysDailySavingsTotal": "Total/day: {total}",
            "ui.keysDailySavingsLoading": "{source} API key prices are still loading for this dungeon.",
            "ui.keysDailySavingsUnavailable": "Load Keys tab import data to compare daily key savings.",
        ...
        "zh-Hans": {
            ...
            "ui.tipDailyKeySavings": "钥匙节省/天：{value}",
            ...
            "ui.keysImportPreviewWithPrices": "(API: {source}) 入场 {entry} | 宝箱 {chest}",
            "ui.keysImportDeltaSaving": "节省 {value}",
            "ui.keysImportDeltaWasting": "多花 {value}",
            ...
            "ui.keysDailySavingsAria": "每日钥匙节省详情",
            "ui.keysDailySavingsTitle": "相较 {source} API 买价的每日钥匙节省",
            "ui.keysDailySavingsEntryLine": "入场钥匙：{each} /把 x {count} = {total}",
            "ui.keysDailySavingsChestLine": "宝箱钥匙：{each} /把 x {count} = {total}",
            "ui.keysDailySavingsTotal": "每日合计：{total}",
            "ui.keysDailySavingsLoading": "{source} API 的该地下城钥匙价格仍在加载中。",
            "ui.keysDailySavingsUnavailable": "请先加载钥匙页导入数据，再比较每日钥匙节省。",
            "ui.minutesWord": "分钟",
            "ui.min": "分钟",
        ...
        "zh-Hant": {
            ...
            "ui.tipDailyKeySavings": "鑰匙節省/天：{value}",
            ...
            "ui.keysImportPreviewWithPrices": "(API: {source}) 入場 {entry} | 寶箱 {chest}",
            "ui.keysImportDeltaSaving": "節省 {value}",
            "ui.keysImportDeltaWasting": "多花 {value}",
            ...
            "ui.keysDailySavingsAria": "每日鑰匙節省詳情",
            "ui.keysDailySavingsTitle": "相較 {source} API 買價的每日鑰匙節省",
            "ui.keysDailySavingsEntryLine": "入場鑰匙：{each} /把 x {count} = {total}",
            "ui.keysDailySavingsChestLine": "寶箱鑰匙：{each} /把 x {count} = {total}",
            "ui.keysDailySavingsTotal": "每日合計：{total}",
            "ui.keysDailySavingsLoading": "{source} API 的該地下城鑰匙價格仍在載入中。",
            "ui.keysDailySavingsUnavailable": "請先載入鑰匙頁匯入資料，再比較每日鑰匙節省。",
            "ui.minutesWord": "分鐘",
            "ui.min": "分鐘",
